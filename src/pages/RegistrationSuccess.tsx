  ...
  <div className="min-h-screen flex items-center justify-center gradient-hero p-4">
    <div className="w-full max-w-lg">
      ...
      <Card className="p-10 text-center">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-charcoal mt-5">Thank you for registering with Grab Hub Puchong.</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-7">
          <Button asChild className="flex-1 gradient-brand"><Link to="/register">Register Another Application</Link></Button>
